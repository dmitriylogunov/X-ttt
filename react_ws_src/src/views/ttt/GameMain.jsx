	...
	render () {
		...
		return (
			<div id='GameMain' className={!showBoard ? 'waiting-state' : ''}>
				...
				<h1>Play {this.props.game_type === 'live' ? (this.state.opp_name ? <span><span className="vs">vs</span> {this.state.opp_name}</span> : 'Online') : <span><span className="vs">vs</span> AI</span>}</h1>
